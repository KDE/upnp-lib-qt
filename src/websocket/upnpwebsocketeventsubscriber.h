...
#ifndef UPNPWEBSOCKETEVENTSUBSCRIBER_H
#define UPNPWEBSOCKETEVENTSUBSCRIBER_H
...
class UpnpWebSocketEventSubscriber : public QObject
{
    Q_OBJECT

public:

    UpnpWebSocketEventSubscriber(QObject *parent = nullptr);

    ~UpnpWebSocketEventSubscriber();
    ...
    void setPublisher(UpnpWebSocketPublisher *publisher);
...
private:
    ...
    UpnpWebSocketEventSubscriberPrivate *d;

};

#endif // UPNPWEBSOCKETEVENTSUBSCRIBER_H
